...
public class BloodpressureTestSamples {
    ...
    public static Bloodpressure getBloodpressureSample1() {
        return new Bloodpressure().id(1L).systolic(1).diastolic(1).pulse(1).recorded_at("recorded_at1");
    }

    public static Bloodpressure getBloodpressureSample2() {
        return new Bloodpressure().id(2L).systolic(2).diastolic(2).pulse(2).recorded_at("recorded_at2");
    }
